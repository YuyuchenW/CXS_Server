#ifndef __CXS_HTTP_HTTP_H__
#define __CXS_HTTP_HTTP_H__
...
public:
    ...
    template <class T>
    bool getParamAs(const std::string &key, T &val, const T &def = T()) {
        return getAs(m_params, key, val, def);
    }
    ...
    template <class T>
    bool getCookieAs(const std::string &key, T &val, const T &def = T()) {
...
public:
    ...
    void setHeaders(MapType headers) {
        m_headers = headers;
    }
